...
Onet::Onet(){
	...
	long keyPoint = initConvAndFc(this->keyPoint_wb, NumPoint*2, 256, 1, 1, 0);
	long dataNumber[21] = { conv1, 32, 32, conv2, 64, 64, conv3, 64, 64, conv4, 128, 128, fc5, 256, 256, score, 2, location, 4, keyPoint, NumPoint *2};
