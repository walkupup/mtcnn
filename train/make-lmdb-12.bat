...
"F:\research\1.CCDL\CCDL\caffe-easy\windows-gpu\caffe\../../Build/gpu_cuda8.0/Release/x64\convert_imageset.exe" "" 12/label-train.txt train_lmdb12 --backend=mtcnn --shuffle=true
